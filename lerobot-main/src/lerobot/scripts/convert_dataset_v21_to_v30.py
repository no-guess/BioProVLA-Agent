...
python src/lerobot/scripts/convert_dataset_v21_to_v30.py \
    --repo-id=lerobot/pusht \
    --root=/home/aimc/.cache/huggingface/lerobot/insert_1.8ml_cryotube_red_rack/demo \
    --push-to-hub=false

# dzh
python src/lerobot/scripts/convert_dataset_v21_to_v30.py \
    --repo-id=lerobot/pusht \
    --root=/home/aimc/.cache/huggingface/lerobot/open_water_bath_lid/demo \
    --push-to-hub=false

python src/lerobot/scripts/convert_dataset_v21_to_v30.py \
    --repo-id=lerobot/pusht \
    --root=/home/aimc/.cache/huggingface/lerobot/close_water_bath_lid/demo \
    --push-to-hub=false

python src/lerobot/scripts/convert_dataset_v21_to_v30.py \
    --repo-id=lerobot/pusht \
    --root=/home/aimc/.cache/huggingface/lerobot/place_float_water_bath/demo \
    --push-to-hub=false

python src/lerobot/scripts/convert_dataset_v21_to_v30.py \
    --repo-id=lerobot/pusht \
    --root=/home/aimc/.cache/huggingface/lerobot/remove_float_water_bath/demo \
    --push-to-hub=false
