...
# dzh
    lerobot-edit-dataset \
        --new_repo_id water_bath_merged \
        --operation.type merge \
        --operation.repo_ids "['open_water_bath_lid', 'close_water_bath_lid', 'place_float_water_bath', 'remove_float_water_bath']" \
        --operation.roots "['/home/aimc/.cache/huggingface/lerobot/open_water_bath_lid/demo', '/home/aimc/.cache/huggingface/lerobot/close_water_bath_lid/demo', '/home/aimc/.cache/huggingface/lerobot/place_float_water_bath/demo', '/home/aimc/.cache/huggingface/lerobot/remove_float_water_bath/demo']" \
        --push_to_hub=false

    double:
    lerobot-edit-dataset \
        --new_repo_id Double_robotic_arm_pouring_liquid \
        --operation.type merge \
        --operation.repo_ids "['Unscrew_centrifuge_tube_cap', 'Liquid_Waste_Pouring', 'Tighten_centrifuge_cap']" \
        --operation.roots "['/home/aimc/.cache/huggingface/lerobot/Unscrew_centrifuge_tube_cap/demo', '/home/aimc/.cache/huggingface/lerobot/Liquid_Waste_Pouring/demo', '/home/aimc/.cache/huggingface/lerobot/Tighten_centrifuge_cap/demo']" \
        --push_to_hub=false
